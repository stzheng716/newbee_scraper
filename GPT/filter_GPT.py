...
Step3) Provide the salary information as {\"salary\": \"See application for details.\"} if it is not stated, or return the partial or full salary range as specified in the job description as a string: \"salary\": \"$int - $int\".  
Step 3) Return an <80 word summary of the job description.
Step 4) Return a \"reasoning\" of why the job is applicable or not. Return as JSON}"""
